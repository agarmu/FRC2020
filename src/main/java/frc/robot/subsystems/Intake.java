...
public class Intake extends SubsystemBase {
  ...
  WPI_VictorSPX rollerBar =
      new WPI_VictorSPX(
          Constants.intakeMotor1); // rollerbar               //ask build which ports theyll use
  WPI_VictorSPX internalBelt = new WPI_VictorSPX(Constants.intakeMotor2); // internal belt thing
  WPI_VictorSPX feeder =
      new WPI_VictorSPX(Constants.intakeMotor3); // the one that puts it in the shooter
